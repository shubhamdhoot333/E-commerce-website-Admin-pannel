				...
				<!--2row-->		<br>
								<div class="row">
									<div class="col-lg-6">
										<table class="table table-striped">
											<font color="red" size="5px" face="segoe script">Successful Message</font>
											<font size="4px">	
											<tr><th> Message Id</th><th>Name</th><th>Mobile No</th></tr>
												<?php
										$query=mysqli_query($conn,"SELECT * FROM message where company_review LIKE 'work successful';");
									...
									<div class="col-lg-6 text-center">
										<form name="search_messgae" method="POST" action="complete_review.php" enctype="multipart/form-data">
									...
									<form name ="search2" method="POST" action="complete_review.php" enctype="multipart/form-data">
											<?php
											if(isset($_REQUEST['Submit']))
						{
										...
										if($id!=="")
								{
										...
										$query="select * from message where id like '$id' and  company_review LIKE 'work successful' ";
