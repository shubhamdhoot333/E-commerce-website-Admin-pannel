...
error_reporting(0);
	...
	//message id submit					
						...
						if(isset($_POST['Submit']))
							...
							$query="select * from rating where id='$id' AND stage IN( 'work successful','show') ";
...
//	submit review
						...
						{					
							...
							{
								$id=$_SESSION['id'];
								$query="update rating set stage='$select' where id='$id'"; 
		...
		<!--container-->
				...
				<!--1row-->		<br>
								<div class="row">
										...
										<label><font color="red"size="5px"face="segoe script"> <u>Customer side Sending Authorised Review </u></font> </label>
										</div>
								</div>
				<!--2row-->		<br>
								<div class="row">
									<div class="col-lg-6 text-center">
										...
										<font color="red" size="5px" face="segoe script">New Message</font>	
											...
											<tr><th> Review Id</th><th>Name</th><th>Area</th></tr>	
													<?php
										$query=mysqli_query($conn,"SELECT * FROM rating where Stage IN('work successful','show')");
									...
									<div class="col-lg-6 text-center">
										<form name="review1" method="POST" action="authorised.php" enctype="multipart/form-data">
										...
										<form name ="review2" method="POST" action="authorised.php" enctype="multipart/form-data">
											...
											<select name="select" class="form-control">
												...
												<option name="show" value="show">Show on Website</option>
