					...
					if(isset($_REQUEST['Submit']))
						{
										...
										if($id!='')
								{
										...
										$query="select * from message where id='$id' AND company_review = '' ";
		...
		<!--container-->
				...
				<!--2row-->		<br>
								<div class="row">
									<div class="col-lg-6 text-center">
										...
										<font color="red" size="5px" face="segoe script">New Message</font>	
											...
											<tr><th> Message Id</th><th>Name</th><th>Mobile No</th></tr>
												<?php
										$query=mysqli_query($conn,"SELECT * FROM message where company_review LIKE '' ");
									...
									<div class="col-lg-6 text-center">
										<form name="search_messgae" method="POST" action="new_message.php" enctype="multipart/form-data">
											<font  color="red" size="3px">Enter  New message Id  to search Message</font>
												<br>
									...
									<form name ="search2" method="POST" action="new_message.php" enctype="multipart/form-data">
