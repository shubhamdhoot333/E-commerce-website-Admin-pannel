		...
		<!--container-->
				...
				<!--1row-->		<div class="row">
									<div class="col-lg-12 text-center">
										<font color="red" size="5px" face="segoe script"><label><u>Deliverd Order </u></label></font>
				...
				<!--2row-->		<div class="row">
						...
						<font size="4px">		<br>
													...
													<?php
														$result=mysqli_query($conn,"SELECT invoice_no,date1,name,cost,quantity FROM order_table where stage in('deliverd','shipping') order by date1 desc");
