...
error_reporting(0);
	...
	//submit review						
							if(isset($_REQUEST['Submit']))
								...
								if($id!=="")
									{
					$query="select * from rating where id like '$id' and  stage LIKE '' ";
		...
		<!--container-->
				...
				<!--1row-->		<br>
								<div class="row">
										...
										<label><font color="red"size="5px"face="segoe script"> <u>Customer side Sending Review </u></font> </label>
										</div>
								</div>
				<!--2row-->		<br>
								<div class="row">
									<div class="col-lg-6 text-center">
										...
										<font color="red" size="5px" face="segoe script">New Message</font>	
											...
											<tr><th> Review Id</th><th>Name</th><th>Area</th></tr>	
													<?php
										$query=mysqli_query($conn,"SELECT * FROM rating where Stage LIKE '';");
									...
									<div class="col-lg-6 text-center">
										<form name="new_review" method="POST" action="newreview.php" enctype="multipart/form-data">
											<font  color="red" size="3px">Enter  New Review Id  to search Message</font>
												<br>
										...
										<form name ="newreview2" method="POST" action="newreview.php" enctype="multipart/form-data">
